...
export type Order = { id: string; external_id: string; ordered_at: string | null; confirmed_at: string | null; status: string; workflow_status: string | null; sales_person: string | null; sales_channel: string | null; total_amount: string | null; currency: string; vehicle_label: string | null; registration_number: string | null; customer: { id: string; name: string; email: string | null; phone: string | null; city: string | null }; workshop: { id: string; name: string; city: string | null } | null; items: OrderItem[] }
